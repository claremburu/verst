...
export default function ApplicationsToolbar({ numSelected, filterName, onFilterName, onDeleteUsers }) {
  ...
  const onSubmit = async () => {
    try {
      ...
      //  await dispatch(createUser(data.clientId, data.groupId, data.userName, data.serverName, data.password));
  ...
  return (
      ...
      >
        ...
        >
          {/* <NewUser onCloseModal={handleClose}/> */}
          </Modal>
        </Box>
      </RootStyle>
