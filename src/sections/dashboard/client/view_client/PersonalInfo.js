...
import { deleteClients, getClient, getClients } from '../../../../redux/slices/clients';
// redux
...
export default function Clients() {
  ...
  return (
    <Card sx={{ p: 2 }} style={{backgroundColor: "#F4F6F8"}}>
    <Stack spacing={2}>
      <Typography variant="h4"> {currentClient?.clientName}</Typography>
      <Typography variant="subtitle1">{currentClient?.clientName}({currentClient?.clientStatus})</Typography>
      <Typography variant="body2">Type: {currentClient?.clientAccessLevel}</Typography>
      <Typography variant="body2">Contact: {currentClient?.contactNumber}</Typography>
      <Typography variant="body2">Please contact your account manager if you have any questions relating to these items or your account in general.
 </Typography>
      {/* {params?.id} */}
      </Stack>
    </Card>
