          ...
          {/* <img src="/logo/logo_full.png" alt="Verst_logo" className='Verst_logo'/> */}
            <Box sx={{ mb: 5, display: 'flex', alignItems: 'center' }}>
              <Box sx={{ flexGrow: 1 }}>
                ...
                <Typography sx={{ color: 'text.secondary' }}>Please ensure the details you provide are accurate, we will use this to verify your account.</Typography>
              </Box>
            ...
            <Typography variant="body2" align="center" sx={{ color: 'text.secondary', mt: 3 }}>
              By registering, I agree to Verst &nbsp;
