...
import { getCampaigns, deleteCampaign } from '../../redux/slices/campaigns';
...
import { AutoResponders } from '../../sections/dashboard/campaigns';

import { CampaignsMoreMenu, CampaignsListHead, CampaignsToolbar } from '../../sections/dashboard/campaigns/campaign';

const TABLE_HEAD = [
  { id: 'name', label: 'Campaign Name', alignRight: false },
  { id: 'campaign', label: 'Campaign', alignRight: false },
  { id: 'status', label: 'Status', alignRight: false },
  { id: 'created', label: 'Created', alignRight: false },
  // { id: 'size', label: 'Market Size', alignRight: true },
  { id: 'type', label: 'Type', alignRight: false },
  // { id: 'time', label: 'Start Time/Date', alignRight: true },
  // { id: 'cost', label: 'Total Cost', alignRight: true },
...
export default function Campaigns() {
  ...
  const handleCreate = () => {
    navigate('/dashboard/campaigns/create', { replace: true });
  };
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            {
              name: 'Campaigns',
              href: PATH_DASHBOARD.campaigns.root,
            },
            { name: 'Campaigns' },
          ]}
        />
                  ...
                  {filteredProducts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <StyledTableCell>{campaignName}</StyledTableCell>
                        <StyledTableCell>{campaignMessage}</StyledTableCell>
                        <StyledTableCell>{campaignStatus}</StyledTableCell>
                        <StyledTableCell>{createDate}</StyledTableCell>
                        {/* <StyledTableCell >{campaignDescription}</StyledTableCell> */}
                        <StyledTableCell>{campaignType}</StyledTableCell>
                        <StyledTableCell>{startDate}</StyledTableCell>
                        {/* <TableCell >{campaignRecurOpt}</TableCell> */}
                        <StyledTableCell align="right">
                          <CampaignsMoreMenu userData={campaignId} onDelete={() => handleDeleteCampaign(campaignId)} />
                        </StyledTableCell>
                      </StyledTableRow>
                    );
                  })}
