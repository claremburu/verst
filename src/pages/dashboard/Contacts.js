...
import { getContacts, deleteContact } from '../../redux/slices/campaigns';
...
import { Contact } from '../../sections/dashboard/campaigns';

import {
ContactsHead, ContactsMoreMenu, ContactsToolbar,
} from '../../sections/dashboard/campaigns/contacts';

const TABLE_HEAD = [
  // { id: 'names', label: 'Names', alignRight: false },
  // { id: 'firstname', label: 'First Name', alignRight: false },
  // { id: 'lastname', label: 'Last Name', alignRight: false },
  { id: 'cell', label: 'Cell', alignRight: false },
...
export default function Contacts() {
  ...
  const { contacts } = useSelector((state) => state.campaigns);
  // console.log('products', contacts);
              ...
              <Table sx={{ minWidth: 650 }} size="small">
                ...
                <TableBody>
                  {filteredProducts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { contactId, names, phone, email, createDate } = row;
                    ...
                    return (
                      ...
                      >
                        <StyledTableCell padding="checkbox">
                          <Checkbox checked={isItemSelected} onClick={() => handleClick(contactId)} />
                        </StyledTableCell>
                        ...
                        {/* <StyledTableCell style={{ minWidth: 160 }}>{contactId}</StyledTableCell> */}
                        ...
                        <StyledTableCell align="right">
                          <ContactsMoreMenu userData={contactId} onDelete={() => handleDeleteContact(contactId)} />
                        </StyledTableCell>
                      </StyledTableRow>
                    );
                  })}
...
function applySortFilter(contacts, comparator, query) {
  ...
  if (query) {
    return contacts.filter((contact) => contact.phone.toLowerCase().indexOf(query.toLowerCase()) !== -1);
  }
